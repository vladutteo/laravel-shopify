...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'Laravel test app'),
    ...
    */
    ...
    'myshopify_domain' => env('SHOPIFY_MYSHOPIFY_DOMAIN', 'https://01a330d92dfd.ngrok.io'),
    ...
    */
    ...
    'webhooks' => [
        [
            ...
            'address' => env('APP_URL') . '/webhook/app-uninstall'
        ],
        /*
            [
    ...
    */
    ...
    'scripttags' => [
            [
                'src' => env('SHOPIFY_SCRIPTTAG_1_SRC', env('APP_URL').'/save_order'),
